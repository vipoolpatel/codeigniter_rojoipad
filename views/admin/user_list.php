...
<table class="gksel_normal_tabaction">
	<tr>
		<td>
			<div class="searcharea" style="width:65%">
				<form action = "<?php echo base_url().'index.php/admins/user/index'?>" method="get" id="newform">
					...
					<select name="user_brandname" class="select_usertype" onchange="javascript:$('#newform').submit();" style="width:300px !important;">
						<option value=""><?php echo lang('cy_all')?></option>
						<?php
	...
	<tr>
		<td>
			<div class="searcharea">
				<a href="<?php echo base_url().'index.php/admins/user/toadd_user/'.$user_type.'?backurl='.$current_url_encode?>"><font class="nav_on"><img class="plus" src="<?php echo base_url().'themes/default/images/plus.png'?>"/> Add Administrator</font></a>
				<!--  
