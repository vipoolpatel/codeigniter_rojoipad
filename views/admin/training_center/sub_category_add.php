...
<div class="gksel_navigation"><a href="<?php echo str_replace('rojoipad/', '', base_url()) ?>rojoipad/index.php/admins/training_center/sub_category/<?=$category_id?>">Sub Category</a> &gt; Add Sub Category</div>
        ...
        <table class="gksel_normal_tabpost">
         <tr>
               <td align="right" width="150">Sub Category (English)</td>
                <td align="left">
                    <input type="text" name="sub_category_en" style="width:90%;" required=""/>
            ...
            <tr>
               <td align="right" width="150">Sub Category (Chenese)</td>
                <td align="left">
                    <input type="text" name="sub_category_ch" style="width:90%;" required=""/>
                    <div class="tipsgroupbox"><div class="request">*</div></div>
                </td>
             </tr>
